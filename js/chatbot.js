    ...
    constructor() {
        ...
        this.knowledge = {
            ...
            kn: {
                ...
                keywords: {
                    'module': "ನಮ್ಮಲ್ಲಿ 5 ಮಾಡ್ಯೂಲ್‌ಗಳಿವೆ. ಇವು ಎಐ ಮೂಲಗಳು, ಡೇಟಾ ಸೈನ್ಸ್ ಮತ್ತು ಕಂಪ್ಯೂಟರ್ ವಿಷನ್ ಬಗ್ಗೆ ತಿಳಿಸುತ್ತವೆ.",
                    'ಮಾಡ್ಯೂಲ್': "ನಮ್ಮಲ್ಲಿ 5 ಮಾಡ್ಯೂಲ್‌ಗಳಿವೆ. ಇವು ಎಐ ಮೂಲಗಳು, ಡೇಟಾ ಸೈನ್ಸ್ ಮತ್ತು ಕಂಪ್ಯೂಟರ್ ವಿಷನ್ ಬಗ್ಗೆ ತಿಳಿಸುತ್ತವೆ.",
                    ...
                    'certificate': "ಹೌದು! ಎಲ್ಲಾ 5 ಮಾಡ್ಯೂಲ್‌ಗಳನ್ನು ಪೂರ್ಣಗೊಳಿಸಿದ ನಂತರ ನೀವು ಅಧಿಕೃತ ಪ್ರಮಾಣಪತ್ರವನ್ನು ಪಡೆಯುತ್ತೀರಿ.",
                    'ಪ್ರಮಾಣಪತ್ರ': "ಹೌದು! ಎಲ್ಲಾ 5 ಮಾಡ್ಯೂಲ್‌ಗಳನ್ನು ಪೂರ್ಣಗೊಳಿಸಿದ ನಂತರ ನೀವು ಅಧಿಕೃತ ಪ್ರಮಾಣಪತ್ರವನ್ನು ಪಡೆಯುತ್ತೀರಿ.",
            ...
            hi: {
                ...
                keywords: {
                    'module': "हमारे पास 5 मॉड्यूल हैं जो एआई बेसिक्स, डेटा साइंस और कंप्यूटर विजन को कवर करते हैं।",
                    'मोड्यूल': "हमारे पास 5 मॉड्यूल हैं जो एआई बेसिक्स, डेटा साइंस और कंप्यूटर विजन को कवर करते हैं।",
                    ...
                    'certificate': "हाँ! सभी 5 मॉड्यूल पूरे करने और अंतिम परीक्षा पास करने के बाद आपको एक सत्यापित प्रमाण पत्र मिलेगा।",
                    'सर्टिफिकेट': "हाँ! सभी 5 मॉड्यूल पूरे करने और अंतिम परीक्षा पास करने के बाद आपको एक सत्यापित प्रमाण पत्र मिलेगा।",
                    'प्रमाण पत्र': "हाँ! सभी 5 मॉड्यूल पूरे करने और अंतिम परीक्षा पास करने के बाद आपको एक सत्यापित प्रमाण पत्र मिलेगा।",
