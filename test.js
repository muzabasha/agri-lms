...
class LectureSystem {
    constructor() {
        ...
        this.specificContent = {
            'm1-t1': {
                ...
                `,
                presentation: `
                    <div class="slides-container" style="position: relative; height: 100%; min-height: 400px; overflow: hidden; background: #1e3a8a; border-radius: 8px; color: white;">
                        <div class="slide active" style="display:flex; flex-direction:column; justify-content:center; align-items:center; height:100%; text-align:center; padding: 20px;">
                            <h1 style="font-size: 2em; margin-bottom: 20px; z-index: 2;">🤖 Artificial Intelligence</h1>
                            <img src="assets/ai_scarecrow.png" style="max-width: 80%; max-height: 250px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.3); z-index: 2;" alt="Smart Scarecrow Analogy">
                            <p style="font-size: 1.2em; margin-top: 15px; z-index: 2;">The Smart Scarecrow That Learns!</p>
                        </div>
                    </div>
                `
            },
            ...
            <div style="background: linear-gradient(135deg, #10b981, #059669); color: white; padding: 30px; border-radius: 12px; text-align: center;">
                ...
                `,
                presentation: `<div style="background: #1e3a8a; height: 400px; color: white; display:flex; flex-direction:column; justify-content:center; align-items:center; padding: 20px;">
                    <h1 style="margin-bottom: 15px;">🧠 ML Paradigms</h1>
                    <img src="assets/ml_paradigms.png" style="max-width: 85%; max-height: 280px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.3);" alt="ML Paradigms Analogy">
                    <p style="margin-top: 10px; font-weight: 300;">Teacher • Explorer • Trial & Error</p>
                </div>`
            },
            'm1-t3': {
                handout: `
                ...
                `,
                presentation: `<div style="background: #2d3748; height: 400px; color: white; display:flex; flex-direction:column; justify-content:center; align-items:center; padding: 20px;">
                    <h1 style="margin-bottom: 15px;">📜 AI History: 1950 → 2024</h1>
                    <img src="assets/farming_history.png" style="max-width: 85%; max-height: 280px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.3);" alt="History of AI in Farming">
                </div>`
            },
            'm1-t4': {
                handout: `
                ...
                `,
                presentation: `<div style="background: #10b981; height: 400px; color: white; display:flex; flex-direction:column; justify-content:center; align-items:center; padding: 20px;">
                    <h1 style="margin-bottom: 15px;">🌾 AI in Agriculture</h1>
                    <img src="assets/ai_tractor.png" style="max-width: 85%; max-height: 280px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.3);" alt="AI Tractor Analogy">
                    <p style="margin-top: 10px;">From Hand Plow to Autopilot</p>
                </div>`
            },
            'm1-t5': {
                handout: `
                ...
                `,
                presentation: `<div style="background: #6366f1; height: 400px; color: white; display:flex; flex-direction:column; justify-content:center; align-items:center; padding: 20px;">
                    <h1 style="margin-bottom: 15px;">💼 AgriTech Careers</h1>
                    <img src="assets/agritech_careers.png" style="max-width: 85%; max-height: 280px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.3);" alt="AgriTech Careers Team">
                    <p style="margin-top: 10px;">Modern Roles for Modern Farms</p>
                </div>`
            },
            'm1-t6': {
                handout: `
            ...
            'm1-t7': {
                ...
                `,
                presentation: `<div style="background: #b45309; height: 400px; color: white; display:flex; flex-direction:column; justify-content:center; align-items:center; padding: 20px;">
                    <h1 style="margin-bottom: 15px;">📊 Statistics Basics</h1>
                    <img src="assets/stats_harvest.png" style="max-width: 85%; max-height: 280px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.3);" alt="Statistics Harvest Analogy">
                    <p style="margin-top: 10px;">Understanding the Average Harvest</p>
                </div>`
            },
            'm1-t8': {
                handout: `
                ...
                `,
                presentation: `<div style="background: #0ea5e9; height: 400px; color: white; display:flex; flex-direction:column; justify-content:center; align-items:center; padding: 20px;">
                    <h1 style="margin-bottom: 15px;">🔢 Linear Algebra</h1>
                    <img src="assets/linear_algebra.png" style="max-width: 85%; max-height: 280px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.3);" alt="Linear Algebra Grid Analogy">
                    <p style="margin-top: 10px;">Farming in Perfect Grids (Matrices)</p>
                </div>`
            },
            'm1-t9': {
                handout: `
                ...
                `,
                presentation: `<div style="background: #8b5cf6; height: 400px; color: white; display:flex; flex-direction:column; justify-content:center; align-items:center; padding: 20px;">
                    <h1 style="margin-bottom: 15px;">🗂️ Data Types</h1>
                    <img src="assets/data_structure.png" style="max-width: 85%; max-height: 280px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.3);" alt="Data Structure Analogy">
                    <p style="margin-top: 10px;">Structured vs Unstructured Data</p>
                </div>`
            },
            'm1-t10': {
                handout: `
                ...
                `,
                presentation: `<div style="background: #14b8a6; height: 400px; color: white; display:flex; flex-direction:column; justify-content:center; align-items:center; padding: 20px;">
                    <h1 style="margin-bottom: 15px;">📡 Data Collection</h1>
                    <img src="assets/iot_cornfield.png" style="max-width: 85%; max-height: 280px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.3);" alt="IoT Cornfield Analogy">
                    <p style="margin-top: 10px;">When Corn Has Ears (IoT Sensors)</p>
                </div>`
            },
            'm1-t11': {
                handout: `
    ...
    getContent(topicId) {
        ...
        if (this.specificContent[mappedId]) {
            ...
            const content = this.specificContent[mappedId];

            // AUTO-UPGRADE: If presentation is the "simple" text-only placeholder, replace with Dynamic Slide Deck
            // The placeholders all use this specific inline style signature
            if (content.presentation && content.presentation.includes('height: 400px; color: white; display:flex; justify-content:center;')) {
                // console.log('[LECTURE-CONTENT] Upgrading placeholder presentation for:', mappedId);
                const dynamic = this.generateDynamicContent(topicId);
                return { ...content, presentation: dynamic.presentation };
            }
    ...
    generateDynamicContent(topicId) {
        ...
        // Smart Hero Image Selection (LOCAL ASSETS ONLY)
        const localImages = [
            'assets/ai_tractor.png',
            'assets/iot_cornfield.png',
            'assets/ai_scarecrow.png',
            'assets/farming_history.png',
            'assets/ml_paradigms.png',
            'assets/linear_algebra.png',
            'assets/stats_harvest.png'
        ];

        // Deterministic selection based on topic char code sum (so it stays consistent per topic)
        const charSum = topicId.split('').reduce((a, b) => a + b.charCodeAt(0), 0);
        let heroImage = localImages[charSum % localImages.length];

        // Specific overrides for Modules to match themes
        if (topicId.startsWith('m1')) heroImage = 'assets/ai_scarecrow.png'; // Introduction
        if (topicId.startsWith('m2-t1')) heroImage = 'assets/stats_harvest.png'; // Stats
        if (topicId.startsWith('m4')) heroImage = 'assets/ai_tractor.png'; // Projects
        if (topicId.startsWith('m5')) heroImage = 'assets/iot_cornfield.png'; // Applications
...
print(f"Status: {classify_machine_health(vib_b)}")`,
        ...
        getContent(topicId) {
            ...
            if (specific && specific.handout) return specific;

            if (topicId.startsWith('m5')) {
                return {
                    handout: this.generateModule5Handout(topic, specific),
                    presentation: this.getModule5Presentation(topic)
                };
            }

            return {
                handout: this.generateGenericHandout(topic),
                presentation: this.generateGenericPresentation(topic)
            };
        }
        ...
        generateGenericHandout(topic) {
            ...
            const subtopicsList = topic.subtopics && topic.subtopics.length > 0
                ? topic.subtopics.map(s => `<li><i class="fas fa-check-circle" style="color: #27ae60;"></i> ${s}</li>`).join('')
                : '<li>Core Concepts</li>';
